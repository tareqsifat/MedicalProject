...
@section('content')
    ...
    <div class="intro-y box mt-5">
        ...
        <form method="POST" action="{{ route('ourwork.update', $collection->id) }}" enctype="multipart/form-data" id="horizontal-form">
            @csrf
            @method('PUT')
            <div class="preview">
                ...
                <div class="form-group p-4">
                    ...
                    <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="body" type="text" class="form-control" value="{{ $collection->body }}">
                </div>                    
                ...
                <div class="form-group p-4">
                    ...
                    <textarea name="message" id="horizontal-form-1" class="form-control" value = "{{ $collection->message }}"></textarea>
                </div>
